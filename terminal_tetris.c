...
int main(int argc, char* argv[argc+1]) {
    ...
    box(hold_window, 0, 0);
    mvwprintw(hold_window, 1, 1, "HOLD");
    mvwprintw(hold_window, 3, 5, "[][]");
    mvwprintw(hold_window, 4, 5, "[][]");
    wrefresh(hold_window);

    int stats_window_h = 15;
    ...
    mvwprintw(stats_window, 1, 1, "STATS");
    mvwprintw(stats_window, 3, 1, "time:");
    mvwprintw(stats_window, 5, 1, "score:");
    mvwprintw(stats_window, 7, 1, "lines:");
    mvwprintw(stats_window, 9, 1, "level:");
    mvwprintw(stats_window, 11, 1, "combo:");
    mvwprintw(stats_window, 13, 1, "fps:");
    ...
    box(next_window, 0, 0);
    mvwprintw(next_window, 1, 1, "NEXT");
    mvwprintw(next_window, 3, 5, "[][]");
    mvwprintw(next_window, 4, 5, "[][]");
    wrefresh(next_window);

    int controls_window_h = 15;
    ...
    mvwprintw(controls_window, 1, 1, "CONTROLS");
    mvwprintw(controls_window, 3, 1, "move:    < >");
    mvwprintw(controls_window, 5, 1, "rotate:  z x");
    mvwprintw(controls_window, 7, 1, "hold:  shift");
    mvwprintw(controls_window, 9, 1, "soft drop: v");
    mvwprintw(controls_window, 11, 1, "hard drop: _");
    mvwprintw(controls_window, 13, 1, "pause:   esc");
