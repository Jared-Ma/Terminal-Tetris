...
bool test_vfx_get(void) {
    VFX vfx = vfx_get(NULL, clear_vfx_lock_piece, 60);
...
bool test_vfx_init(void) {
    VFX* vfx = vfx_init(NULL, clear_vfx_lock_piece, 60);
    ASSERT(vfx->game_window == NULL);
    ASSERT(vfx->draw_vfx == NULL);
    ASSERT(vfx->clear_vfx == clear_vfx_lock_piece);
    ASSERT(vfx->frame_timer == 0);
...
bool test_vfx_enable_lock_piece(void) {
    VFX vfx_lock_piece = vfx_get(NULL, clear_vfx_lock_piece, LOCK_PIECE_VFX_FRAMES);
...
bool test_vfx_enable_line_clear(void) {
    VFX vfx_line_clear = vfx_get(NULL, clear_vfx_line_clear, LINE_CLEAR_VFX_FRAMES);
    GameState game_state = game_state_get();
...
bool test_vfx_enable_hold_piece(void) {
    VFX vfx_hold_piece = vfx_get(NULL, clear_vfx_hold_piece, HOLD_PIECE_VFX_FRAMES);
    GameState game_state = game_state_get();
...
bool test_vfx_enable_next_piece(void) {
    VFX vfx_next_piece = vfx_get(NULL, clear_vfx_next_piece, NEXT_PIECE_VFX_FRAMES);
    GameState game_state = game_state_get();
...
bool test_vfx_enable_action_line_clear(void) {
    ...
    VFX vfx_action = vfx_get(&stats_window, clear_vfx_action, ACTION_VFX_FRAMES);
    GameState game_state = game_state_get();
...
bool test_vfx_enable_combo(void) {
    GameWindow stats_window = game_window_get(STATS_WINDOW_H, STATS_WINDOW_W, STATS_WINDOW_Y, STATS_WINDOW_X);
    VFX vfx_combo = vfx_get(&stats_window, clear_vfx_combo, COMBO_VFX_FRAMES);
    GameState game_state = game_state_get();
...
bool test_vfx_enable_b2b(void) {
    GameWindow stats_window = game_window_get(STATS_WINDOW_H, STATS_WINDOW_W, STATS_WINDOW_Y, STATS_WINDOW_X);
    VFX vfx_b2b_combo = vfx_get(&stats_window, clear_vfx_b2b_combo, B2B_COMBO_VFX_FRAMES);
    GameState game_state = game_state_get();
...
bool test_vfx_enable_points(void) {
    GameWindow stats_window = game_window_get(STATS_WINDOW_H, STATS_WINDOW_W, STATS_WINDOW_Y, STATS_WINDOW_X);
    VFX vfx_points = vfx_get(&stats_window, clear_vfx_points, POINTS_VFX_FRAMES);
    GameState game_state = game_state_get();
...
bool test_vfx_enable_level_up(void) {
    ...
    VFX vfx_level_up = vfx_get(&board_window, clear_vfx_level_up, LEVEL_UP_VFX_FRAMES);
    GameState game_state = game_state_get();
...
bool test_vfx_enable_stats_lines(void) {
    GameWindow stats_window = game_window_get(STATS_WINDOW_H, STATS_WINDOW_W, STATS_WINDOW_Y, STATS_WINDOW_X);
    VFX vfx_stats_lines = vfx_get(&stats_window, clear_vfx_stats_lines, STATS_LINES_VFX_FRAMES);
    GameState game_state = game_state_get();
...
bool test_vfx_enable_stats_level(void) {
    GameWindow stats_window = game_window_get(STATS_WINDOW_H, STATS_WINDOW_W, STATS_WINDOW_Y, STATS_WINDOW_X);
    VFX vfx_stats_level = vfx_get(&stats_window, clear_vfx_stats_level, STATS_LEVEL_VFX_FRAMES);
    GameState game_state = game_state_get();
